...
def i_am_leader(
    leader_id: int, leader_ip: str, leader_tcp_port: int, epoch: int, last_seq: int
) -> Dict[str, Any]:
    return {
        "type": "I_AM_LEADER",
        "leader_id": leader_id,
...
def new_order(
    sender_id: int, order_uuid: str, payload: Dict[str, Any]
) -> Dict[str, Any]:
    return {
        "type": "NEW_ORDER",
        "sender_id": sender_id,
...
def order_msg(
    leader_id: int, epoch: int, seq: int, order_uuid: str, payload: Dict[str, Any]
) -> Dict[str, Any]:
    return {
        "type": "ORDER",
        "leader_id": leader_id,
